...
if __name__ =='__main__' and sys.argv[1]=='train':
    ...
    with tf.Session() as sess:
        ...
        print ("trainingset_image:%s,trainingset_lables%s" % (input_count, input_count))
        ...
        print ("the training set is divided into%s,%sper set" % (batches_count+1, batch_size))
        ...
        for it in range(iterations):
            ...
            if it%5 == 0:
                ...
                print ('%dth: accurate:%0.5f%%' % (it, iterate_accuracy*100))
        ...
        print ("time cost:%d" % time_elapsed)
...
if __name__ =='__main__' and sys.argv[1]=='predict':
    ...
    with tf.Session() as sess:
        ...
        for n in range(1,4):
            ...
            print ("proability:  [%s %0.2f%%] [%s %0.2f%%] [%s %0.2f%%]" % (LETTERS_DIGITS[max1_index],max1*100, LETTERS_DIGITS[max2_index],max2*100, LETTERS_DIGITS[max3_index],max3*100))
